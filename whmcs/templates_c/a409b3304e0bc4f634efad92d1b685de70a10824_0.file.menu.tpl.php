...
/* Smarty version 3.1.29, created on 2017-11-17 16:23:48
  from "/var/www/html/whmcs/admin/templates/lara/menu.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5a0eff043429c3_03461610',
  'file_dependency' => 
  array (
    'a409b3304e0bc4f634efad92d1b685de70a10824' => 
    array (
      0 => '/var/www/html/whmcs/admin/templates/lara/menu.tpl',
      1 => 1510931598,
      2 => 'file',
    ),
  ),
...
function content_5a0eff043429c3_03461610 ($_smarty_tpl) {
if (!is_callable('smarty_modifier_replace')) require_once '/var/www/html/whmcs/vendor/smarty/smarty/libs/plugins/modifier.replace.php';
?>
...
</span> <?php if (in_array("List Support Tickets",$_smarty_tpl->tpl_vars['admin_perms']->value) && $_smarty_tpl->tpl_vars['sidebarstats']->value['tickets']['active']) {?><span style="padding:0.2em 0.6em 0.3em; margin-right:25px;" class="label bg-red pull-right"><?php echo $_smarty_tpl->tpl_vars['sidebarstats']->value['tickets']['active'];?>
</span><?php }?><i class="fa fa-angle-left pull-right"></i></a>
				  <ul class="treeview-menu">
...
if ($_smarty_tpl->tpl_vars['sidebarstats']->value['tickets']['active']) {?><span style="padding:0.2em 0.6em 0.3em; margin-right:25px;" class="label bg-red pull-right"><?php echo $_smarty_tpl->tpl_vars['sidebarstats']->value['tickets']['active'];?>
</span><?php }?><i class="fa fa-angle-left pull-right"></i></a>
						<ul class="treeview-menu">
...
if ($_smarty_tpl->tpl_vars['sidebarstats']->value['tickets']['active']) {?><span style="padding:0.2em 0.6em 0.3em; " class="label bg-red pull-right"><?php echo $_smarty_tpl->tpl_vars['sidebarstats']->value['tickets']['active'];?>
</span><?php }?></a></li>
...
if ($_smarty_tpl->tpl_vars['sidebarstats']->value['tickets']['flagged']) {?><span style="padding:0.2em 0.6em 0.3em; " class="label bg-yellow pull-right"><?php echo $_smarty_tpl->tpl_vars['sidebarstats']->value['tickets']['flagged'];?>
</span><?php }?></a></li>
...
<i class="fa fa-angle-left pull-right"></i></a>
				...
				<a id="Menu-Utilities" href="#"><i class="fa fa-th-large"></i><span><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['utilities']['title'];?>
				  ...
				  <ul class="treeview-menu">
					...
					<?php if (in_array("Browser",$_smarty_tpl->tpl_vars['admin_perms']->value)) {?><li><a id="Menu-Utilities-Browser" href="browser.php"><i class="fa fa-external-link "></i><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['utilities']['browser'];?>
</a></li><?php }?>
...
?>
					<li><a id="Menu-Addons-Addons_Directory" href="addonmodules.php"><i class="fa fa-list "></i><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['utilities']['addonsdirectory'];?>
</a></li>
				  </ul>
				</li>
...
<i class="fa fa-angle-left pull-right"></i></a>
				...
				<li><a id="Menu-Help" href="#"><i class="fa fa-question-circle"></i><span><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['help']['title'];?>
				  ...
				  <ul class="treeview-menu">
					...
					<?php if (in_array("Health and Updates",$_smarty_tpl->tpl_vars['admin_perms']->value)) {?><li><a id="Menu-Help-Check_Health_Updates" href="systemhealthandupdates.php"><i class="fa fa-refresh"></i><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['healthCheck']['menuTitle'];?>
</a></li><?php }?>
					<?php if (in_array("Configure General Settings",$_smarty_tpl->tpl_vars['admin_perms']->value)) {?><li><a id="Menu-Help-Get_Help" href="systemsupportrequest.php"><i class="fa fa-life-ring"></i><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['help']['support'];?>
</a></li><?php }?>
