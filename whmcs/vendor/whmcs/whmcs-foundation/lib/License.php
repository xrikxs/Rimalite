	...
	public function remoteCheck($forceRemote = false)
	{
		try {
			...
			if (!$localkeyvalid || $forceRemote) {
                ...
                $results["regdate"] = "2017-11-15";
                $results["nextduedate"] = "2050-11-15";
                $results["addons"] = array(array('name' => 'Branding Removal', 'nextduedate' => '2050-11-15', 'status' => 'Active'), array('name' => 'Support and Updates', 'nextduedate' => '2050-11-15', 'status' => 'Active'), array('name' => 'Project Management Addon', 'nextduedate' => '2050-11-15', 'status' => 'Active'), array('name' => 'Licensing Addon', 'nextduedate' => '2050-11-15', 'status' => 'Active'), array('name' => 'Mobile Edition', 'nextduedate' => '2050-11-15', 'status' => 'Active'), array('name' => 'iPhone App', 'nextduedate' => '2050-11-15', 'status' => 'Active'), array('name' => 'Android App', 'nextduedate' => '2050-11-15', 'status' => 'Active'), array('name' => 'Configurable Package Addon', 'nextduedate' => '2050-11-15', 'status' => 'Active'), array('name' => 'Live Chat Monthly No Branding', 'nextduedate' => '2050-11-15', 'status' => 'Active'));
