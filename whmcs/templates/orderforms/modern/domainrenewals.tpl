...
<div class="table-responsive"><table align="center" cellspacing="1" class="renewals">
...
<p align="center"><input class="btn btn-success"  type="submit" value="{$LANG.ordernowbutton} &raquo;" /></p>

</form>

<hr />

<p align="center"><input class="btn btn-primary" type="button" value="{$LANG.viewcart}" onclick="window.location='cart.php?a=view'" /></p>
