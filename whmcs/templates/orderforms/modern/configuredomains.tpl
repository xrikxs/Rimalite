...
<tr><td width="120">{$LANG.domainnameserver1}:</td><td><input type="text" class="form-control" name="domainns1" size="40" value="{$domainns1}" /></td></tr>
<tr><td>{$LANG.domainnameserver2}:</td><td><input type="text" class="form-control" name="domainns2" size="40" value="{$domainns2}" /></td></tr>
<tr><td>{$LANG.domainnameserver3}:</td><td><input type="text" class="form-control" name="domainns3" size="40" value="{$domainns3}" /></td></tr>
<tr><td>{$LANG.domainnameserver4}:</td><td><input type="text" class="form-control" name="domainns4" size="40" value="{$domainns4}" /></td></tr>
<tr><td>{$LANG.domainnameserver5}:</td><td><input type="text" class="form-control" name="domainns5" size="40" value="{$domainns5}" /></td></tr>
</table></div>
</div>
{/if}

<p align="center"><input type="submit" class="btn btn-primary" value="{$LANG.updatecart}" /></p>
