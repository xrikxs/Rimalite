...
<div class="table-responsive"><table align="center" cellspacing="1" class="domainsuggestions">
...
{if $continueok}<p align="center"><input type="submit" class="btn btn-success" value="{$LANG.ordercontinuebutton}" /></p>{/if}
